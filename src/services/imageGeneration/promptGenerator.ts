...
import { ImagePromptContext, GeneratedImagePrompt } from './types';

const GEMINI_API_KEY = import.meta.env.VITE_GEMINI_API_KEY;
const FLASH_MODEL = "gemini-3-flash-preview";

const IMAGE_PROMPT_SYSTEM = `
You are helping generate creative, context-aware image prompts for Kayley. 
...
Kayley's Style:
- Warm, approachable, natural
- Hair can be curly, straight, or in a messy bun (based on context/request)
...
${context.currentLookLock ? `- Current Look Lock: Hairstyle: ${context.currentLookLock.hairstyle}, Outfit: ${context.currentLookLock.outfit}` : ''}
