...
//     start: {
//       dateTime: new Date(
//         MOCK_DATE.getTime() + 2 * 60 * 60 * 1000
//       ).toISOString(),
//     },
//   },
// ];
...
//       );
//       expect(getSelfieRulesConfig(friendRelationship)).toMatchSnapshot(
//         "selfie-config-friend"
//       );
...
//       expect(BRIEF_RESPONSE_EXAMPLES).toMatchSnapshot(
