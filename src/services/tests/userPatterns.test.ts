...
describe("callbackDirector pattern integration", () => {
  // These tests verify the callback director correctly integrates patterns
  
  describe("getPatternCallback", () => {
    it("should be exported from callbackDirector", async () => {
      const { getPatternCallback } = await import("../callbackDirector");
      
      expect(typeof getPatternCallback).toBe('function');
    });
  });

  describe("markPatternCallbackUsed", () => {
    it("should be exported from callbackDirector", async () => {
      const { markPatternCallbackUsed } = await import("../callbackDirector");
      
      expect(typeof markPatternCallbackUsed).toBe('function');
    });
  });

  describe("trackPatternsFromMessage", () => {
    it("should be exported from callbackDirector", async () => {
      const { trackPatternsFromMessage } = await import("../callbackDirector");
      
      expect(typeof trackPatternsFromMessage).toBe('function');
    });
  });

  describe("resetPatternSession", () => {
    it("should be exported from callbackDirector", async () => {
      const { resetPatternSession } = await import("../callbackDirector");
      
      expect(typeof resetPatternSession).toBe('function');
    });
  });

  describe("getFullEnhancedCallbackPrompt", () => {
    it("should be exported from callbackDirector", async () => {
      const { getFullEnhancedCallbackPrompt } = await import("../callbackDirector");
      
      expect(typeof getFullEnhancedCallbackPrompt).toBe('function');
    });
  });

  describe("resetAllCallbackSessions", () => {
    it("should be exported from callbackDirector", async () => {
      const { resetAllCallbackSessions } = await import("../callbackDirector");
      
      expect(typeof resetAllCallbackSessions).toBe('function');
    });
  });
});
