...
//   //     expect(prompt).toContain("FRIEND"); //  has tier: "friend"
//   //   });
...
//         const prompt1 = await buildSystemPromptForGreeting();
//         const prompt2 = await buildSystemPromptForGreeting();
...
//         const friendPrompt =
//           await buildSystemPromptForGreeting();
...
//       //     //  has moderate values (warmth: 5, trust: 3)
...
//   //     const result = getSelfieRulesConfig();
...
//   //     //  has moderate values (warmth: 5, trust: 3)
//   //     const result = buildDynamicDimensionEffects();
