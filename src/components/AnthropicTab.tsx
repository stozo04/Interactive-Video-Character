    ...
    <div className="h-full flex flex-col gap-4">
      ...
      <div className="border border-gray-700 rounded-xl bg-gray-900/50 p-4">
        <div className="flex items-center gap-3 mb-4">
          <h3 className="text-sm font-semibold text-gray-300">Authentication</h3>
          ...
          <div className="space-y-3">
            <div className="border border-amber-600/30 rounded-lg p-3 bg-amber-900/20">
              ...
              <p className="text-sm text-amber-200">
                OAuth is experimental. Anthropic hasn't opened public OAuth app registration yet.
                Once they do, set VITE_ANTHROPIC_CLIENT_ID in your environment and this PKCE flow will work.
              </p>
            </div>
