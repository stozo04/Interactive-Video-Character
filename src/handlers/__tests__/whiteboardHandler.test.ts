...
describe('whiteboardHandler', () => {
  ...
  describe('handleWhiteboardCapture', () => {
    ...
    it('should update AI session after response', async () => {
      const updatedSession = { model: 'gemini-2.0-flash', interactionId: 'new-id' };
    ...
    it('should handle errors gracefully', async () => {
      mockOptions.activeService.generateResponse.mockRejectedValue(new Error('API Error'));
      ...
      expect(result.textResponse).toBe("Hmm, I had trouble seeing your drawing. Try again?");
    });
